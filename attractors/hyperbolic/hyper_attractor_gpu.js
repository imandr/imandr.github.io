...
let HyperGPU = class
{
    ...
    {
        this.Rate = 0.02;
        this.PMin = [0, 0, 0, 0, -0.2, -0.2];
        this.PMax = [3, 3, 3, 3, 0.2, 0.2];
        const R = 3.0;
        this.XMin = [-R, -R];
        this.XMax = [R, R];
        this.XDim = 2;
...
let SingleHyperGPU = class
{
    constructor(canvas_element)
    {
        this.NP = 50000;
        this.D = new HyperGPU(this.NP, 0.03);
        this.margin = 0;
...
let DuelingHyperGPU = class
{
    constructor(canvas_element)
    {
        const NP = 40000;
        this.D1 = new HyperGPU(NP, 0.03);
        this.D2 = new HyperGPU(NP, 0.03);
        this.margin = 0;
        const w = window.innerWidth;
        const h = window.innerHeight;
    ...
    step()
    {
        ...
        this.C.points(points1, c1, 0.4*share);
        this.C.points(points2, c2, 0.4*(1-share));
